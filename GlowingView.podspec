#
#  Be sure to run `pod spec lint GlowingView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "GlowingView"
  s.version      = "0.0.1"
  s.summary      = "A UIView extension adds customisable glow effect based on CALayer shadows."
...
```
  ...
  s.homepage     = "https://github.com/cemolcay/GlowingView"
  ...
  s.source       = { :git => "https://github.com/cemolcay/GlowingView.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "GlowingView/GlowingView.swift"
